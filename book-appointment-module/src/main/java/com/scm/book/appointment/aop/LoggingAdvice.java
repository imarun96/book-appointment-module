package com.scm.book.appointment.aop;
...
import com.scm.book.appointment.repository.LoggingSaverRepository;
...
public class LoggingAdvice {
	...
	@Pointcut("execution(* com.scm.book.appointment.controller.*.*(..) ) || execution(* com.scm.book.appointment.dao.*.*(..) )")
